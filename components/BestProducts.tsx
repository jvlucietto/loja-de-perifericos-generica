...
const BestProducts = ({ headMessage, peripheral}: Props) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center w-full mb-7 '>
       <div className=" w-[76%] flex items-center justify-start   text-orange-500 text-2xl  font-bold py-4 ">
        <h2>{headMessage}</h2>
      </div>

      <div className=" grid  grid-cols-5 grid-rows-2  gap-y-10 gap-x-5 w-fit ">
